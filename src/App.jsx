          ...
          <div className='container_content'>
            ...
            <section className='Projects_Section' id='Projects'>
              ...
              <div className='Projects_Container'>
                ...
                <div className='Project_Card'>
                  <img src={medicarelogo} alt="Medicare" />
                  <div className='Project_Info'>
                    <p className='Project_Title'>MediCare System</p>
                    <p className='Project_Description'>
                      A cross-platform system to manage patients, caregivers, and medications. Built with Laravel and Flutter, it features medication scheduling, reminders and secure roles</p>
                    <div className='Project_Technologies'>
                      <p className='pt'>Flutter</p>
                      <p className='pt'>Dart</p>
                      <p className='pt'>Php</p>
                      <p className='pt'>Laravel</p>
                      <p className='pt'>Mysql</p>
                      <p className='pt'>MVC</p>
                      <p className='pt'>MVVC</p>
                    </div>
                    <a href='https://github.com/kronen9999/mediCare' target='_blank' className='linkGit'>Code<img className='gitImage' src={github} alt="" /></a>
                  </div>
                </div>
              </div>
